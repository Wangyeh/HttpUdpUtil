...
public final class RxJavaHooks {
    ...
    static volatile Func1<OnSubscribe, OnSubscribe> onObservableCreate;

    @SuppressWarnings("rawtypes")
    static volatile Func1<Single.OnSubscribe, Single.OnSubscribe> onSingleCreate;

    static volatile Func1<CompletableOnSubscribe, CompletableOnSubscribe> onCompletableCreate;

    @SuppressWarnings("rawtypes")
    static volatile Func2<Observable, OnSubscribe, OnSubscribe> onObservableStart;

    @SuppressWarnings("rawtypes")
    static volatile Func2<Single, OnSubscribe, OnSubscribe> onSingleStart;

    static volatile Func2<Completable, CompletableOnSubscribe, CompletableOnSubscribe> onCompletableStart;
    ...
    static void init() {
        ...
        onSingleStart = new Func2<Single, OnSubscribe, OnSubscribe>() {
            @Override
        ...
        onCompletableStart = new Func2<Completable, CompletableOnSubscribe, CompletableOnSubscribe>() {
            @Override
    ...
    public static <T> OnSubscribe<T> onCreate(OnSubscribe<T> onSubscribe) {
     ...
     * @return the original or replacement OnSubscribe instance
     */
    public static CompletableOnSubscribe onCreate(CompletableOnSubscribe onSubscribe) {
        Func1<CompletableOnSubscribe, CompletableOnSubscribe> f = onCompletableCreate;
        if (f != null) {
            return f.call(onSubscribe);
        }
        return onSubscribe;
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static <T> OnSubscribe<T> onSingleStart(Single<T> instance, OnSubscribe<T> onSubscribe) {
        Func2<Single, OnSubscribe, OnSubscribe> f = onSingleStart;
        if (f != null) {
            return f.call(instance, onSubscribe);
        }
        return onSubscribe;
     ...
     * @return the original or alternative action that will be subscribed to
     */
    public static <T> CompletableOnSubscribe onCompletableStart(Completable instance, CompletableOnSubscribe onSubscribe) {
     ...
     * @return the original or alternative operator that will be subscribed to
     */
    public static <T, R> CompletableOperator onCompletableLift(CompletableOperator operator) {
    ...
    public static void setOnCompletableCreate(
            Func1<CompletableOnSubscribe, CompletableOnSubscribe> onCompletableCreate) {
        if (lockdown) {
            return;
        }
    ...
    public static void setOnObservableCreate(
            Func1<OnSubscribe, OnSubscribe> onObservableCreate) {
        if (lockdown) {
            return;
        }
    ...
    public static void setOnCompletableStart(
            Func2<Completable, CompletableOnSubscribe, CompletableOnSubscribe> onCompletableStart) {
        if (lockdown) {
            return;
        }
    ...
    public static void setOnObservableStart(
            Func2<Observable, OnSubscribe, OnSubscribe> onObservableStart) {
        if (lockdown) {
            return;
        }
     ...
     */
    @SuppressWarnings("rawtypes")
    public static void setOnSingleStart(Func2<Single, OnSubscribe, OnSubscribe> onSingleStart) {
        if (lockdown) {
            return;
        }
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Func1<OnSubscribe, OnSubscribe> getOnObservableCreate() {
     ...
     * @return the current hook function
     */
    public static Func1<CompletableOnSubscribe, CompletableOnSubscribe> getOnCompletableCreate() {
     ...
     * @return the current hook function
     */
    public static Func2<Completable, CompletableOnSubscribe, CompletableOnSubscribe> getOnCompletableStart() {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Func2<Observable, OnSubscribe, OnSubscribe> getOnObservableStart() {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static Func2<Single, OnSubscribe, OnSubscribe> getOnSingleStart() {
