...
/**
 * This operator modifies an {@link Observable} so a given action is invoked when the
 * {@link Producer} receives a request.
 * 
 * @param <T>
 *            The type of the elements in the {@link Observable} that this operator modifies
 */
